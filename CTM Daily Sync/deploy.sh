...
JOB_NAME="ctm-daily-job"              # Your descriptive job name
IMAGE_NAME="gcr.io/$PROJECT_ID/$JOB_NAME"
SCHEDULER_JOB_NAME="ctm-daily-job-scheduler-trigger"  # Your schedule name

echo "🚀 Smart deployment for CTM daily job..."
...
echo "✅ Updated/created daily schedule: 12:00 AM UTC"
echo ""
...
echo "🎯 Test schedule now: gcloud scheduler jobs run $SCHEDULER_JOB_NAME --location=$REGION"
